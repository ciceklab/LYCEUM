...
> The repository with processed samples, ground truth data, and CNV predictions for real and simulated datasets to reproduce the analyses in the paper can be found here: <a href="https://doi.org/10.5281/zenodo.13997011" target="_blank">**LYCEUM results reproduction**</a>
