...
python ./scripts/finetune_preprocess_sample.py --readdepth ./read_depths --output ./processed_finetuning_samples --target hg38_hglft_genome_64dc_dcbaa0_unique.bed
